// Script para crear/actualizar el comercial Gabriel Vargas Cantos
...
async function crearComercial() {
  ...
  try {
    ...
    // Datos del comercial
    const comercial = {
      Nombre: 'Gabriel Vargas Cantos',
      Email: 'gcantos68@gmail.com',
      DNI: '21476033J', // Convertir a mayúsculas
      Password: '21476033J', // Usar DNI como contraseña inicial
      Roll: '["Comercial"]',
      Movil: '', // Campo requerido, usar cadena vacía si no se proporciona
      Direccion: 'Plaza luceros 16,5',
      CodigoPostal: '03004',
      Poblacion: 'Alicante'
    };
