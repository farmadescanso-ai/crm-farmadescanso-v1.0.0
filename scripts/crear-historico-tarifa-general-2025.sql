-- ============================================
-- Histórico de Tarifa General 2025
-- Copia los precios actuales de la Tarifa General (Id=0) a una tarifa cerrada:
--   "General 2025" (01/01/2025 - 31/12/2025)
--
-- Objetivo:
...
VALUES (
  ...
  '2025-01-01',
  '2025-12-31',
  'Histórico: copia de la tarifa General (Id=0) para preservar precios del año 2025'
);

-- 2) Obtener el Id de "General 2025"
...
-- 3) Copiar precios desde General (0) hacia General 2025
